window.TerraAccount = (() => {
  ...
  async function profileForm(target){
    ...
    form.append(nameField,field('Cidade',city),field('UF',state),field('Tipo de conta — informação declarada',type),photoField,field('Descrição pública',description),field('CRECI declarado',creci),el('p',{class:'small'},'Informação fornecida pelo anunciante. O preenchimento não cria selo de verificação.'),field('Site (HTTPS)',website),field('Instagram (usuário)',instagram),field('WhatsApp com DDD',phone),field('Disponibilizar WhatsApp nos meus anúncios ativos',enabled),el('p',{class:'small'},'O WhatsApp é a única forma de contato com anunciantes no Terra à Vista Imóveis. Cadastre e habilite seu número antes de publicar. Ele não aparece no perfil público e só é liberado quando alguém escolhe entrar em contato.'),el('p',{class:'small'},profile.phone_verified?'Telefone verificado.':'Não exibimos selo de telefone verificado sem validação.'),submit);
